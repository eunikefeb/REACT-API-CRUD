    ...
    render() {
        return (
            <div className="card-body">
                    <input type="text" className="form-control mb-2" name="search" value={this.state.search} onChange={this.bind} onKeyUp={this.findPegawai} placeholder="Seacrh here..." />
                    <div className="m-10 card">
                    {/* tampilan tabel pegawai */}
                    <br></br><h5><center>Data Pegawai</center></h5>
                ...
                <center><button className="btn btn-success" onClick={this.add} data-toggle="modal" data-target="#modal">
                        Tambah Data
                    </button></center>
            </div>
